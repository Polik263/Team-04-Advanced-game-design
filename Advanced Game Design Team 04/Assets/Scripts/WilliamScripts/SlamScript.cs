...
public class SlamScript : MonoBehaviour
{
    ...
    {
        if(!isCoolingDown && SwordScript.Instance.CurrentSwordState == SwordScript.SwordState.Dark && (DialogueManagerScript.Instance == null || !DialogueManagerScript.Instance.isInDialogue))
        {
